...
继续使用 `apps/editor/renderer/src/store/useEditorStore.js` 作为唯一全局状态入口。
...
- `apps/editor/main/main.js`
- `apps/editor/main/preload.js`
...
- `main/storage/db.js`
- `main/storage/workspaceRepository.js`
- `main/storage/settingsRepository.js`
...
`apps/editor/renderer/src/utils/workspaceIO.js` 的 JSON 格式继续兼容现有工作区结构。
